...
function Experience() {
  return (
    <section className="pt-28 px-6 xl:px-[150px]">
      <section className="max-w-[1280px] w-full flex flex-col gap-6 mx-auto">
        {experience.map((item) => (
          <div className="grid grid-cols-12 gap-6 items-start" key={item.id}>
            <div className="col-span-12 md:col-span-3 bg-white flex items-center justify-center px-10 md:px-4 xl:px-10 rounded-2xl shadow border py-5 md:py-7">
